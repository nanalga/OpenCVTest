...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //hist
        findViewById(R.id.HB).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void getHist(){
        ...
        if(null!=imageView.getDrawable()){
            ImageView histView = findViewById(R.id.Histo);
            Bitmap hist = Hist.getHist(((BitmapDrawable)imageView.getDrawable()).getBitmap());
            Log.i("test", "height" + hist.getHeight()+" width" + hist.getWidth());

            histView.setImageBitmap(hist);
        }
